...
export default function Header() {
  ...
  return (
    <header
      className={`fixed z-[30] w-full flex justify-between dark:bg-[#121212] items-center h-[60px] px-6 max-[643px]:px-2 bg-white transition-all duration-500 ease-in-out ${
    ...
    >
      <div className="flex items-center gap-5 max-[643px]:w-full max-[643px]:justify-between">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-black dark:text-white font-bold text-2xl max-[400px]:text-xl">Mobil-X</h1>
        </div>
      </div>
...
<div className="flex max-[643px]:hidden items-center gap-[15px]">
         <div onClick={()=>{dispatch(openCategorySheet())}} className="rounded-[7px] flex items-center justify-center p-[8px] cursor-pointer  transition-all duration-300">
          <BiCategoryAlt className="text-gray-600 dark:text-[#A8A8A8] w-6 h-6" />
        </div>
